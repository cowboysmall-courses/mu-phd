...
def main() -> None:
    ...
    sdc   = SDCParitySimulation(SCAFFOLDS, ANCHOR, TILES, SOLUTION, 250, {"TOTALS": [], "STATS": {}})
    data  = sdc.run(iters)
    ...
    plt.title("SDC - Time Evolution of Parity Computation")
    plt.grid(True)
    plt.xlabel("Timestep")
    plt.ylabel("Solved")
    ...
    plt.legend()
    plt.savefig("./output/experiments/sdc/bind_replace/experiment_parity.png")
    plt.close()
